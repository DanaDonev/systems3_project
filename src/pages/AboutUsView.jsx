    ...
    <>
      <div className="container about-section" style={{maxWidth: '70%'}}>
        <div className="p-3 rounded shadow my-5 bg-body-tertiary">
          ...
          <p className="subtitle mb-4">Because your pet deserves a second home, not just a place to stay.</p>
          ...
          <div>
            <p>
              We know how much your pet means to you. That’s why we built <span className="highlight">PetSitter</span> —
              a platform that connects pet owners with trusted sitters who treat animals like their own family.
            </p>
            <p>
              Whether you’re heading out for a trip or just need temporary help, we make it easy to find someone who
              will love and care for your pet in a home-like setting.
            </p>
            <p>
